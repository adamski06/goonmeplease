    ...
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <main className="flex-1 relative z-10">
        ...
        <div className="fixed left-1/2 top-1/2 -translate-y-1/2 flex flex-col gap-4" style={{ marginLeft: 'calc((100vh - 48px) * 9 / 16 / 2 + 32px)' }}>
          <button className="px-8 py-4 rounded-full bg-black text-white flex items-center justify-center hover:bg-black/80 transition-colors gap-1">
            <span className="text-2xl font-bold">{currentCampaign.ratePerThousand} sek</span>
            <span className="text-xs text-white/70">/ 1000 views</span>
          </button>
