...
const Campaigns: React.FC = () => {
  ...
  return (
    <div className="h-screen flex relative overflow-hidden">
      ...
      {/* Left Sidebar */}
      <aside className="w-56 lg:w-52 flex flex-col relative z-10 bg-white dark:bg-white/10 backdrop-blur-sm border-r border-transparent dark:border-white/20">
        {/* Logo */}
        ...
        {/* More Menu at bottom */}
        <div className="mt-auto px-3 py-4 border-t border-transparent dark:border-white/20">
          <DropdownMenu>
      ...
      <main className="flex-1 relative z-10 flex flex-col">
        {/* Top Filter Bar */}
        <div className="h-14 bg-white dark:bg-white/10 backdrop-blur-sm border-b border-transparent dark:border-white/20 flex items-center px-6 gap-3 shrink-0">
