      ...
      <main className="flex-1 relative z-10 flex flex-col">
        ...
        {viewMode === 'scroll' ? (
          ...
          <div className="relative flex-1 overflow-hidden">
            <div className="pt-8 pb-8 pl-8 pr-16 overflow-y-auto h-full">
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-x-4 gap-y-16 justify-items-start">
