              ...
              {campaigns.map((campaign, index) => {
                ...
                return (
                  <div
                    key={campaign.id}
                    onClick={() => setSelectedCampaign(campaign)}
                    className="rounded overflow-hidden cursor-pointer hover:scale-[1.01] transition-all group flex flex-row relative border border-white/40 dark:border-transparent max-w-[280px]"
                  >
                    {/* Left side - Image */}
