...
const Campaigns: React.FC = () => {
  ...
  return (
    <div className="h-screen flex relative overflow-hidden">
      ...
      {/* Left Sidebar */}
      <aside className="w-56 lg:w-52 flex flex-col relative z-10 backdrop-blur-md border-r border-white/40 dark:border-white/20" style={{ background: 'linear-gradient(to bottom, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.4) 100%)' }}>
        {/* Logo */}
                  ...
                  >
                    ...
                    <div className="flex-1 p-6 flex flex-col justify-between relative">
                      ...
                      <div className="relative z-10 mt-4">
                        <div className="bg-black/80 text-white text-sm font-semibold px-4 py-1.5 rounded-full inline-block">
                    ...
                    <div className="relative w-24 md:w-32 aspect-[9/16] flex-shrink-0 m-3 rounded-xl overflow-hidden">
