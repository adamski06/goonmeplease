  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          background: 'radial-gradient(ellipse 180% 120% at 50% 130%, hsl(220, 70%, 55%) 0%, hsl(215, 60%, 70%) 35%, transparent 65%)'
        }}
      />
      <div className="noise-layer absolute inset-0 pointer-events-none opacity-50" />
      
      {/* Left Sidebar */}
      <aside className="w-64 flex flex-col relative z-10 border-r border-white/25" style={{ backgroundColor: 'hsla(220, 70%, 55%, 0.18)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', backdropFilter: 'blur(24px) saturate(180%)' }}>
        {/* Logo */}
      ...
      <main className="flex-1 relative z-10">
        {/* View Mode Toggle */}
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-20 flex gap-1 p-1.5 rounded-full border border-white/25" style={{ backgroundColor: 'hsla(220, 70%, 55%, 0.18)', WebkitBackdropFilter: 'blur(24px) saturate(180%)', backdropFilter: 'blur(24px) saturate(180%)' }}>
          <button
