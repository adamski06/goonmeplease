      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
        ...
        <div className="max-w-7xl mx-auto flex items-end gap-4">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <button className="signup-button px-6 py-2 text-base font-bold font-montserrat bg-aurora-sync text-black rounded-full transition-all duration-300">
              ...
              {activeTab === 'creator' ? (
                <>
                  ...
                  <div className="flex justify-center mt-8">
                    <button className="signup-button px-10 py-4 text-xl font-bold font-montserrat bg-aurora-sync text-black rounded-full transition-all duration-300">
                      <span className="relative z-10">Sign up</span>
                    </button>
                  </div>
                </>
