...
const Index = () => {
  ...
  return <div className="bg-gradient-aurora">
      ...
      {/* Fixed Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex items-center gap-4 after:absolute after:inset-x-0 after:top-0 after:h-16 after:bg-gradient-to-b after:from-black/40 after:to-transparent after:-z-10 after:pointer-events-none after:animate-fade-in">
