...
const Index = () => {
  ...
  return <div className="bg-gradient-aurora">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex items-end gap-4">
        ...
        {/* Tabs next to logo */}
        <div className="flex border-[3px] border-white rounded-full overflow-hidden ml-8">
          <TabButtons />
        </div>
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button className="px-5 py-1.5 text-sm font-bold font-montserrat btn-aurora-shine text-black rounded-full hover:opacity-90 transition-opacity">
            Sign up
          </button>
        </div>
      </nav>
