...
const Index = () => {
  ...
  const TabButtons = () => (
    <>
      <button
        ...
        className={`px-4 py-1 text-sm font-bold font-montserrat rounded-l-full border-2 border-white border-r-0 ${
          activeTab === 'creator' 
            ? 'bg-white text-black' 
      ...
      <button
        ...
        className={`px-4 py-1 text-sm font-bold font-montserrat rounded-r-full border-2 border-white border-l-0 ${
          activeTab === 'business' 
            ? 'bg-white text-black' 
            : 'text-white hover:bg-white hover:text-black'
        }`}
  ...
  return <div className="bg-gradient-aurora">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 flex items-end gap-4">
        ...
        {/* Tabs next to logo */}
        <div className="flex rounded-full overflow-hidden ml-8">
          <TabButtons />
        </div>
