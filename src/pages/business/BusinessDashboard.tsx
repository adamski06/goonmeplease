        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-[500px]">
            ...
            <div className="space-y-16">
              ...
              <Card className="bg-white/40 dark:bg-dark-surface backdrop-blur-xl border-0 rounded-none p-6">
                <h2 className="text-xl font-semibold mb-3">Summer Vibes</h2>
                <div className="flex items-stretch gap-3">
                  <div className="flex flex-col gap-2">
                    <Card className="bg-white/70 dark:bg-white/10 backdrop-blur-lg border-0 rounded-none shadow-sm w-[780px]">
                    ...
                    <Card className="bg-white/70 dark:bg-white/10 backdrop-blur-lg border-0 rounded-none shadow-sm">
