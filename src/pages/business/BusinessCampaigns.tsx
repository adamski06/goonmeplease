                  ...
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                    <CardContent className="px-8 py-3">
                      <div className="flex items-center gap-3">
                        <span className="text-6xl font-bold font-geist">{formatExact(stats.totalViews)}</span>
                  ...
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                    <CardContent className="px-6 py-2">
                      <div className="flex items-center gap-2">
                        <span className="text-3xl font-normal font-geist">47 823 sek</span>
                        <span className="text-3xl font-normal font-geist">/</span>
                        <span className="text-3xl font-normal font-geist">100 000 sek</span>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
              ...
              <div className="flex items-stretch gap-3">
                <div className="flex flex-col gap-2 flex-1">
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                    <CardContent className="px-8 py-3">
                      <div className="flex items-center gap-3">
                        <span className="text-6xl font-bold font-geist">618 234</span>
                        <span className="text-6xl font-normal font-geist">views</span>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                    <CardContent className="px-6 py-2">
                      <div className="flex items-center gap-2">
                        <span className="text-3xl font-normal font-geist">23 412 sek</span>
                        <span className="text-3xl font-normal font-geist">/</span>
                        <span className="text-3xl font-normal font-geist">50 000 sek</span>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
              ...
              <div className="flex items-stretch gap-3">
                <div className="flex flex-col gap-2 flex-1">
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                    <CardContent className="px-8 py-3">
                      <div className="flex items-center gap-3">
                        <span className="text-6xl font-bold font-geist">241 567</span>
                        <span className="text-6xl font-normal font-geist">views</span>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                    <CardContent className="px-6 py-2">
                      <div className="flex items-center gap-2">
                        <span className="text-3xl font-normal font-geist">9 234 sek</span>
                        <span className="text-3xl font-normal font-geist">/</span>
                        <span className="text-3xl font-normal font-geist">25 000 sek</span>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
