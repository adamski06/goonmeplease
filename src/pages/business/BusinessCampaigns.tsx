                  ...
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                    <CardContent className="px-6 py-2">
                      <div className="flex items-center gap-2">
                        <span className="text-3xl font-normal font-montserrat">47 823 sek</span>
                        <span className="text-3xl font-normal font-montserrat">/</span>
                        <span className="text-3xl font-normal font-montserrat">100 000 sek</span>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                  ...
                  <CardContent className="px-8 py-6 h-full">
                    <div className="flex h-full flex-col justify-between font-montserrat">
                      ...
                      <div className="flex justify-between items-baseline gap-4">
                        ...
                        <span className="text-lg font-normal">0.037</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              <div className="flex items-stretch gap-3">
                <div className="flex flex-col gap-2 flex-1">
                  ...
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                    <CardContent className="px-6 py-2">
                      <div className="flex items-center gap-2">
                        <span className="text-3xl font-normal font-montserrat">23 412 sek</span>
                        <span className="text-3xl font-normal font-montserrat">/</span>
                        <span className="text-3xl font-normal font-montserrat">50 000 sek</span>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                ...
                <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                  <CardContent className="px-8 py-6 h-full">
                    <div className="flex h-full flex-col justify-between font-montserrat">
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Budget</span>
                        <span className="text-lg font-normal">50k</span>
                      </div>
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Left</span>
                        <span className="text-lg font-normal">27k</span>
                      </div>
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Pending</span>
                      ...
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Approved</span>
                        <span className="text-lg font-normal">15</span>
                      </div>
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Creators</span>
                        <span className="text-lg font-normal">11</span>
                      </div>
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">CPV</span>
                        <span className="text-lg font-normal">0.037</span>
              ...
              <div className="flex items-stretch gap-3">
                <div className="flex flex-col gap-2 flex-1">
                  ...
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                    <CardContent className="px-6 py-2">
                      <div className="flex items-center gap-2">
                        <span className="text-3xl font-normal font-montserrat">9 234 sek</span>
                        <span className="text-3xl font-normal font-montserrat">/</span>
                        <span className="text-3xl font-normal font-montserrat">25 000 sek</span>
                      </div>
                    </CardContent>
                  </Card>
                  <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                ...
                <Card className="bg-white/70 dark:bg-white/10 border-0 rounded-[4px] shadow-[0_0_15px_rgba(0,0,0,0.06)] dark:shadow-[0_0_15px_rgba(0,0,0,0.3)]">
                  <CardContent className="px-8 py-6 h-full">
                    <div className="flex h-full flex-col justify-between font-montserrat">
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Budget</span>
                        <span className="text-lg font-normal">25k</span>
                      </div>
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Left</span>
                        <span className="text-lg font-normal">16k</span>
                      </div>
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Pending</span>
                      ...
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Approved</span>
                        <span className="text-lg font-normal">9</span>
                      </div>
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">Creators</span>
                        <span className="text-lg font-normal">8</span>
                      </div>
                      <div className="flex justify-between items-baseline gap-4">
                        <span className="text-base text-muted-foreground font-normal">CPV</span>
                        <span className="text-lg font-normal">0.037</span>
