  ...
  return (
    <div className="h-full overflow-y-auto scrollbar-thin pr-0">
      ...
      <div className="flex gap-4 items-start">
        {tiktokEmbedUrl ? (
          <div className="flex-shrink-0 rounded-2xl overflow-hidden" style={{ width: Math.ceil(325 * 0.649), height: 480, background: 'hsl(var(--background))' }}>
            <iframe
              src={tiktokEmbedUrl}
              style={{ width: 325, height: 740, border: 'none', display: 'block', transform: 'scale(0.649)', transformOrigin: 'top left', colorScheme: 'normal' }}
        ...
        {tiktokUsername && (
          <iframe
            ...
            style={{ width: 580, height: 480, border: 'none', display: 'block', background: 'hsl(var(--background))', colorScheme: 'normal' }}
            allow="encrypted-media"
            allowFullScreen
          />
        )}
