            ...
            {step === 2 && (
              <div className="space-y-6">
                ...
                <div className="rounded-xl border border-border bg-muted/50 p-4 text-sm text-muted-foreground">
                  ...
                  <p>You'll be charged <span className="font-semibold text-foreground">$1.00 per 1,000 views</span> per submission, up to a max of <span className="font-semibold text-foreground">$1.00 per video</span>. A payment method will be saved during checkout.</p>
                </div>
              </div>
            )}
