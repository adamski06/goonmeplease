...
const allCampaigns = [
  { id: '00000000-0000-0000-0000-000000000001', brand: 'Nike', description: 'Show your workout routine', maxEarnings: 875, logo: nikeLogo, image: fitnessWorkout },
  { id: '00000000-0000-0000-0000-000000000002', brand: 'Spotify', description: 'Share your music moments', maxEarnings: 875, logo: spotifyLogo, image: musicLifestyle },
  { id: '00000000-0000-0000-0000-000000000003', brand: 'Samsung', description: 'Unbox the new Galaxy', maxEarnings: 875, logo: samsungLogo, image: techUnboxing },
  { id: '00000000-0000-0000-0000-000000000004', brand: 'Red Bull', description: 'Capture extreme moments', maxEarnings: 875, logo: redbullLogo, image: extremeSports },
  { id: '00000000-0000-0000-0000-000000000005', brand: 'Adobe', description: 'Show your creative process', maxEarnings: 875, logo: adobeLogo, image: creativeDesign },
  { id: '00000000-0000-0000-0000-000000000006', brand: 'Samsung', description: 'Mobile photography tips', maxEarnings: 875, logo: samsungLogo, image: mobileCreative },
  { id: '00000000-0000-0000-0000-000000000007', brand: 'Red Bull', description: 'Summer energy vibes', maxEarnings: 875, logo: redbullLogo, image: summerDrink },
  { id: '00000000-0000-0000-0000-000000000008', brand: 'Spotify', description: 'Concert experience', maxEarnings: 875, logo: spotifyLogo, image: entertainment },
  { id: '00000000-0000-0000-0000-000000000009', brand: 'Nike', description: 'Street style showcase', maxEarnings: 875, logo: nikeLogo, image: streetStyle },
  { id: '00000000-0000-0000-0000-000000000010', brand: 'Red Bull', description: 'Adventure POV shots', maxEarnings: 875, logo: redbullLogo, image: adventurePov },
  { id: '00000000-0000-0000-0000-000000000011', brand: 'Spotify', description: 'Morning coffee playlist', maxEarnings: 875, logo: spotifyLogo, image: coffeeMoment },
  { id: '00000000-0000-0000-0000-000000000012', brand: 'Samsung', description: 'Gaming setup tour', maxEarnings: 875, logo: samsungLogo, image: gaming },
  { id: '00000000-0000-0000-0000-000000000013', brand: 'Nike', description: 'Fashion forward looks', maxEarnings: 875, logo: nikeLogo, image: fashionStyle },
  { id: '00000000-0000-0000-0000-000000000014', brand: 'Samsung', description: 'Tech unboxing haul', maxEarnings: 875, logo: samsungLogo, image: unboxingHaul },
  { id: '00000000-0000-0000-0000-000000000015', brand: 'Adobe', description: 'Home office setup', maxEarnings: 875, logo: adobeLogo, image: homeInterior },
  { id: '00000000-0000-0000-0000-000000000016', brand: 'Red Bull', description: 'Quick meal energy', maxEarnings: 875, logo: redbullLogo, image: fastFood },
  { id: '00000000-0000-0000-0000-000000000017', brand: 'Spotify', description: 'Food delivery unboxing', maxEarnings: 875, logo: spotifyLogo, image: foodDelivery },
  { id: '00000000-0000-0000-0000-000000000018', brand: 'Samsung', description: 'Electric car review', maxEarnings: 875, logo: samsungLogo, image: electricCar },
];
