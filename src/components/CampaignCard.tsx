...
const CampaignCard: React.FC<CampaignCardProps> = ({
  ...
  return (
    <div ref={cardRef} className="h-[calc(100dvh-80px)] relative flex flex-col items-center justify-start snap-start snap-always overflow-hidden">
      ...
      <div className="absolute top-16 left-0 right-0 bottom-0 pointer-events-none transition-opacity duration-700" style={{ opacity: glowVisible ? 0.7 : 0 }}>
        <img src={campaign.image || placeholderBlue} alt="" className="w-full h-full object-cover scale-[1.3] blur-[50px] saturate-200" decoding="async" />
      </div>
