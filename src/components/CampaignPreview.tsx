...
const CampaignPreview: React.FC<CampaignPreviewProps> = ({
  ...
  return (
    <div className="flex flex-col h-full -mt-2 -mr-4">
      ...
      <div className="flex items-center h-14 px-4 backdrop-blur-md bg-gradient-to-b from-white/95 to-white/40 dark:from-dark-surface dark:to-dark-surface border-r-0">
