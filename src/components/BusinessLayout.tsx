...
const BusinessLayout: React.FC<BusinessLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="h-screen flex relative overflow-hidden">
      ...
      {/* Left Sidebar */}
      <aside className={`${isFormRoute ? 'w-16' : 'w-56 lg:w-52'} flex flex-col relative z-10 backdrop-blur-md bg-gradient-to-b from-white/95 to-white/40 dark:from-dark-surface dark:to-dark-surface font-geist transition-[width] duration-500 ease-in-out border-r border-black/10 dark:border-white/20`}>
        {/* Logo */}
