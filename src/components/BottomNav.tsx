  ...
  return (
    ...
    >
      <div className="flex items-start justify-between h-full">
        ...
        >
          <svg
            className={`h-6 w-6 ${isActive('/user') ? activeColor : inactiveColor}`}
            viewBox="0 0 24 24"
            fill="currentColor"
          >
        ...
        >
          <svg
            className={`h-6 w-6 ${isActive('/user/discover') ? activeColor : inactiveColor}`}
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
        ...
        {/* Action */}
        <button
          onClick={() => handleProtectedNav('/user/activity')}
          className="flex flex-col items-center gap-1 pt-1 w-12"
        >
          <svg
            className={`h-6 w-6 ${isActive('/user/activity') ? activeColor : inactiveColor}`}
            viewBox="0 0 24 24"
            fill="currentColor"
          >
            <path
        ...
        <button
          onClick={() => handleProtectedNav('/user/alerts')}
          className="flex flex-col items-center gap-1 pt-1 w-12"
        >
          <svg
            className={`h-6 w-6 ${isActive('/user/alerts') ? activeColor : inactiveColor}`}
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
