      ...
      <div className="flex gap-16">
        ...
        <div className="flex-1">
          ...
          <div className="mb-6">
            ...
            {/* Black line with pointer at end */}
            <div className="flex items-start">
              <div className="flex-1 h-[2px] bg-black mt-[6px]" />
              <div className="w-0 h-0 border-l-[8px] border-l-transparent border-r-[8px] border-r-transparent border-t-[8px] border-t-black" />
            </div>
            {/* Views needed */}
